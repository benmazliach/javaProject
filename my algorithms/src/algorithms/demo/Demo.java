...
import algorithms.search.Solusion;
...
public class Demo {
	...
	*/
	public void run(int lines, int floors, int columns)
	{
		 ...
		 */
		Solusion<Position> s = searcher.search(searchable);
		 ...
		 * @return Solution<Position>
		 */
		Solusion<Position> s1 = searcher1.search(searchable);
		 ...
		 * @return Solution<Position>
		 */
		Solusion<Position> s2 = searcher2.search(searchable);
